  ...
  return (
    <div className="flex items-center overflow-hidden">
      <div className=" w-screen h-screen p-2 lg:p-12 xl:px-48">
        <div className="flex flex-col xl:flex-row justify-start lg:justify-around h-full p-2 xl:p-8 xl:hover:bg-orange-600 xl:scale-95 xl:hover:scale-100 xl:hover: xl:hover:border-[16px] xl:border-black transition-all duration-200 ease-in-out">
          <div>
            <Image
              src={`/quinoa.jpg`}
              alt="salade"
          ...
          <div className="flex flex-col justify-around items-start text-slate-200 w-full xl:w-full">
            ...
            <div>
              ...
              <ul className="pl-4">
                ...
                <li>
                  <p>
                    Mélange le quinoa, les légumes grillés, la feta et le jus de
                    citron dans un grand bol.
                  </p>
                </li>
              </ul>
            </div>
          ...
          <div className="flex flex-col justify-around items-start text-slate-200 w-full xl:w-full">
            ...
            <div>
              ...
              <ul className="pl-4">
                ...
                <li>
                  <p>
                    Ajoute les champignons et fais-les revenir jusqu’à ce qu’ils
                    soient dorés.
                  </p>
                </li>
                <li>
        ...
        <div className="flex flex-col xl:flex-row justify-start lg:justify-around h-full p-2 xl:p-8 xl:hover:bg-orange-600 xl:scale-95 xl:hover:scale-100 xl:hover: xl:hover:border-[16px] xl:border-black transition-all duration-200 ease-in-out">
          ...
          <div className="flex flex-col justify-around items-start text-slate-200 w-full xl:w-full">
            ...
            <div>
              ...
              <ul className="pl-4">
                <li>
                  <p>Fais cuire les pâtes selon les instructions du paquet.</p>
                </li>
                <li>
                  <p>
          ...
          <div className="flex flex-col justify-around items-start text-slate-200 w-full xl:w-full">
            ...
            <div>
              ...
              <ul className="pl-4">
                <li>
                  <p>
                    Coupez les avocats en deux, retirez le noyau et récupérez la
                    chair dans un bol. Écrasez-la à la fourchette jusqu’à
                ...
                <li>
                  <p>
                    ...
                    ajouter des flocons de piment rouge pour un peu de piquant.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    Étalez généreusement l’avocat assaisonné sur les tranches de
                    pain grillé. Arrosez d’un filet d’huile d’olive si vous le
                    souhaitez.
                  </p>
                </li>
                <li>
